...
r_override="window{location:${x_pos} ${y_pos};anchor:${x_pos} ${y_pos};x-offset:${x_off}px;y-offset:${y_off}px;border:3px;border-radius:50px;} wallbox{border-radius:50px;} element{border-radius:50px;}"
