...
r_override="window{location:${x_pos} ${y_pos};anchor:${x_pos} ${y_pos};x-offset:${x_off}px;y-offset:${y_off}px;border:${hypr_width}px;border-radius:3px;} wallbox{border-radius:3px;} element{border-radius:${elem_border}px;}"
