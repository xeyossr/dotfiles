        ...
        fetch('/data.json')
            ...
            .then(data => {
                ...
                if (task) {
                    ...
                    document.getElementById('edit_template').value = task.template;
                    document.getElementById('edit_price').value = task.price;
            ...
            taskDiv.innerHTML = `
                <div class="task-info" data-id="${task.id}">
                    ...
                    <div class="task-details">
                        ...
                        <span>Güncel fiyat: ${task.current_price} - Beklenen fiyat: ${task.price}</span>
                    </div>
