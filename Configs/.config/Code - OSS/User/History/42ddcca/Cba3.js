...
document.querySelector('.calculate').addEventListener('click', () => {
    const fenPosition = game.fen();  // Mevcut pozisyonu FEN formatında al
    const playerColor = userColor;  // Kullanıcının rengi
    ...
    .then(data => {
        ...
        console.log(`Best move for ${playerColor}: ${bestMove}`);
        
        // En iyi hamleyi tahtaya uygula
        game.move(bestMove);
        board.position(game.fen());
    })
