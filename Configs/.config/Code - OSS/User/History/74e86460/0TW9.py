...
def submit_form():
    ...
    if name_element and price_element and image_element:
        ...
        image_url = templates[template]['site_url'] + image_element.find('img').get('src')
